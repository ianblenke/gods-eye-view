...
- [x] 2.1 Tag one old test and write two tests for `cyclones-001` in `source.test.mjs`. The test name starts with `[cyclones-001]`.
...
- [x] 2.3 Tag one old test and write one test for `cyclones-003` in `source.test.mjs`. The test name starts with `[cyclones-003]`.
...
- [x] 2.4 Tag one old test and write five tests for `cyclones-004` in `source.test.mjs`. The test name starts with `[cyclones-004]`.
...
- [x] 2.5 Tag one old test and write three tests for `cyclones-005` in `source.test.mjs`. The test name starts with `[cyclones-005]`.
...
- [x] 2.6 Tag one old test and write two tests for `cyclones-006` in `source.test.mjs`. The test name starts with `[cyclones-006]`.
...
- [x] 2.7 Tag one old test and write two tests for `cyclones-007` in `source.test.mjs`. The test name starts with `[cyclones-007]`.
...
- [x] 2.8 Tag two old tests and write four tests for `cyclones-008` in `source.test.mjs`. The test name starts with `[cyclones-008]`.
...
- [x] 3.1 Tag two old tests and write two tests for `cyclones-009` in `labels.test.mjs`. The test name starts with `[cyclones-009]`.
...
- [x] 3.2 Tag one old test and write three tests for `cyclones-010` in `labels.test.mjs`. The test name starts with `[cyclones-010]`.
...
- [x] 3.3 Tag one old test and write one test for `cyclones-011` in `labels.test.mjs`. The test name starts with `[cyclones-011]`.
...
- [x] 4.1 Tag two old tests and write seven tests for `cyclones-012` in `rendering.test.mjs`. The test name starts with `[cyclones-012]`.
...
- [x] 4.2 Tag one old test and write one test for `cyclones-013` in `rendering.test.mjs`. The test name starts with `[cyclones-013]`.
...
- [x] 4.3 Tag four old tests and write one test for `cyclones-014` in `rendering.test.mjs`. The test name starts with `[cyclones-014]`.
...
- [x] 4.4 Tag two old tests and write one test for `cyclones-015` in `rendering.test.mjs`. The test name starts with `[cyclones-015]`.
...
- [x] 4.5 Tag six old tests and write three tests for `cyclones-016` in `rendering.test.mjs`. The test name starts with `[cyclones-016]`.
...
- [x] 4.6 Tag two old tests and write three tests for `cyclones-017` in `rendering.test.mjs`. The test name starts with `[cyclones-017]`.
...
- [x] 5.2 Tag one old test and write five tests for `cyclones-019` in `index.test.mjs`. The test name starts with `[cyclones-019]`.
...
- [x] 5.3 Tag three old tests and write eight tests for `cyclones-020` in `index.test.mjs`. The test name starts with `[cyclones-020]`.
...
- [x] 5.4 Tag three old tests and write seven tests for `cyclones-021` in `index.test.mjs`. The test name starts with `[cyclones-021]`.
...
- [x] 5.6 Tag three old tests and write one test for `cyclones-023` in `index.test.mjs`. The test name starts with `[cyclones-023]`.
...
- [x] 5.7 Tag two old tests and write five tests for `cyclones-024` in `index.test.mjs`. The test name starts with `[cyclones-024]`.
...
- [x] 5.8 Tag three old tests and write six tests for `cyclones-025` in `index.test.mjs`. The test name starts with `[cyclones-025]`.

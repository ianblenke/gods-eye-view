...
- `range-slack`: In a file with a range, a change can remove the coverage of some lines, branches or functions. The number that it removes can be at most the width of the range. The spec adversary checks each changed test for these files.

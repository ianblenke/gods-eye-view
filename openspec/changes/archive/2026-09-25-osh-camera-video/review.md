...
- [x] Round 4 ste-adversary S1 to S6, S12, S13 and S16 (minor): kept. Each needs a change of the scenario text, of a test name or of a comment in a test file, and so a new ratchet and a new round for a wording point. The list is in `review/round-4/skeptics.md`. The person who merges reads it and accepts it.

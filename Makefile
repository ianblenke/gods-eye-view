...
# such as .env, can change the coverage of the tests. The copy also gets .git and the
# kept coverage samples. Each copy step stops the target when it fails. The container command
